...
more workloads, and official support). It was a paid, yearly license agreement
sold at $400 per host.

After the acquisition however, Sysbox Enterprise is no longer offered as a
standalone product but will instead be incorporated into [Docker Desktop][docker-desktop].
As this may not suite all users, Docker plans to port some Sysbox-EE features to
Sysbox-CE so users can replace the former with the latter. Please refer to
[this announcement][sysbox-ee] for further info.

At this time, **no new licenses of Sysbox-EE are sold and no license renewals will
be offered**. This repo will remain open for existing customers as a way to
download Sysbox-EE binaries, but will be phased out by April 2023 (after all
...
**NOTE: as Sysbox-EE is being phased out, some (but not all) of these features
will be ported to Sysbox-CE. See next section for more info.**
...
Nestybox was [acquired by Docker][docker-acquisition] on 05/2022.
